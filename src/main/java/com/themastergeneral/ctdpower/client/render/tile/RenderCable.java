package com.themastergeneral.ctdpower.client.render.tile;
...
import com.themastergeneral.ctdpower.client.DestroyStage;
import com.themastergeneral.ctdpower.client.utils.RenderBlocks;
import com.themastergeneral.ctdpower.te.cables.TileCable;
import com.themastergeneral.ctdpower.utilty.TileMapper;

public class RenderCable extends TileEntitySpecialRenderer<TileCable>
{
	@Override
	public void renderTileEntityAt(TileCable te, double x, double y, double z, float pt, int tp)
	{
	...
	public static void renderWire(TileCable te, double x, double y, double z, TextureAtlasSprite texture)
	{
		...
		for(EnumFacing f : EnumFacing.VALUES)
		{
			...
			if(tt instanceof TileCable || tt instanceof IEnergyConnection)
			{
				if(tt instanceof IEnergyConnection && ((IEnergyConnection) tt).canConnectEnergy(f.getOpposite())) conns.put(f, true);
				else if(tt instanceof TileCable) conns.put(f, true);
